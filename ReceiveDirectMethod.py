...
CONNECTION_STRING = "HostName=iot-aztest726-ay220726.azure-devices.net;DeviceId=berry-pi;SharedAccessKey=HNW6Ojih/taD6RylhnYnhn1hQef4fPReLrlTe8WJrBU="
...
def run_telemetry_sample(client):
    ...
    while True:
        ...
        if temperature > 28:
            message.custom_properties["temperatureHighAlert"] = "true"
            message.custom_properties["temperatureLowAlert"] = "false"
        elif temperature < 24:
            message.custom_properties["temperatureHighAlert"] = "false"
            message.custom_properties["temperatureLowAlert"] = "true"
        else:
            message.custom_properties["temperatureHighAlert"] = "false"
            message.custom_properties["temperatureLowAlert"] = "false"
